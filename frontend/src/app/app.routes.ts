...
export const appRoutes: Routes = [
  // 1. PUBLIC STATIC & CATALOG ROUTES (Wrapped in PublicLayout)
  {
    ...
    children: [
      ...
      },
      {
        path: "about",
        loadComponent: () =>
          import("./features/static/about/about.component").then(
            (m) => m.AboutComponent,
          ),
      ...
      },
      {
        path: "how-it-works",
        loadComponent: () =>
          import("./features/static/how-it-works/how-it-works.component").then(
      ...
      },
      {
        path: "resources",
        loadComponent: () =>
          import("./features/resources/resource-list/resource-list.component").then(
  ...
  // 2. AUTHENTICATED APP ROUTES (Wrapped in AppLayout, Guarded per child)
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import("./features/resources/resource-create/resource-create.component").then(
            (m) => m.ResourceCreateComponent,
          ),
      ...
      },
      {
        path: "resources/mine",
        loadComponent: () =>
          import("./features/resources/my-resources/my-resources.component").then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import("./features/handovers/handover-detail/handover-detail.component").then(
            (m) => m.HandoverDetailComponent,
          ),
      ...
      },
      {
        path: "contributions",
        loadComponent: () =>
          import("./features/contributions/contributions-list/contributions-list.component").then(
            (m) => m.ContributionsListComponent,
          ),
      ...
      },
      {
        ...
        loadComponent: () =>
          import("./features/organizations/org-register/org-register.component").then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import("./features/organizations/org-dashboard/org-dashboard.component").then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import("./features/organizations/org-verification/org-verification.component").then(
            (m) => m.OrgVerificationComponent,
          ),
    ...
    children: [
      {
        path: "resources/:id",
        loadComponent: () =>
          import("./features/resources/resource-detail/resource-detail.component").then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import("./features/organizations/org-profile/org-profile.component").then(
  ...
  // 4. ADMIN OPERATIONAL ROUTES (Wrapped in AdminLayout, Role Guarded)
  {
    ...
    children: [
      ...
      },
      {
        path: "organizations",
        loadComponent: () =>
          import("./features/admin/admin-organizations/admin-organizations.component").then(
      ...
      },
      {
        path: "resources",
        loadComponent: () =>
          import("./features/admin/admin-resources/admin-resources.component").then(
      ...
      },
      {
        path: "requests",
        loadComponent: () =>
          import("./features/admin/admin-requests/admin-requests.component").then(
  ...
  // 5. WILDCARD NOT FOUND
  {
    path: "**",
    loadComponent: () =>
      import("./features/static/not-found/not-found.component").then(
